...
void Test2(void)
{
	...
	printf("Test 2C: decimal number leading zeros off,  with dots on \r\n");
	...
	printf("Test 2D: decimal number leading zeros on ,  with dots on\r\n");
	...
	printf("Test 2E: decimal number all dots on\r\n");
